...
/// <summary>
/// Applies a function to each element of tree, threading an accumulator through the computation.
...
/// <summary>
/// Applies a function to each element of tree in reverse order, threading an accumulator through the computation.
...
/// <summary>
/// Converts the tree into a tree.
/// </summary>
/// <param name="tree">The input tree.</param>
/// <returns>A tree with all the items contained by the tree and in the same order.</returns>
let toList tree =
    foldBack (fun item tree -> item :: tree) tree []
...
/// The generator is called repeatedly the build the tree until it returns <c>None</c>.
...
/// <summary>
/// Returns a tree that contains the elements generated by the computation.
/// The generator is called repeatedly the build the tree until it returns <c>ValueNone</c>.
/// The given initial <c>state</c> argument is passed to the element generator.
/// </summary>
/// <param name="generator">A function that takes in the current state and returns option tuple of the next element of the tree and the next state value.</param>
/// <param name="state">The initial state value.</param>
...
/// <param name="outer">The number of trees in the outer tree.</param>
...
/// <summary>
/// Converts an untyped <c>IEnumerator</c> in a tree of objects.
/// </summary>
...
/// <summary>
/// Converts an <c>IEnumerator&lt;'t&gt;</c> to a tree of 't.
/// </summary>
/// <param name="enumerator">The enumerator to convert.</param>
/// <returns>The resulting tree.</returns>
/// <exception cref="System.NullArgumentException"><c>enumerator</c> was null.</exception>
...
/// <summary>
/// Converts an object that acts like a collection (that is, has <c>Count</c> and <c>Item</c> defined) to a tree.
/// </summary>
...
/// <summary>
/// Replaces all instances of <c>before</c> in the tree with <c>after</c>.
/// </summary>
/// <param name="before">The value to replace.</param>
/// <param name="after">The value to replace with.</param>
/// <param name="tree">The input tree.</param>
/// <returns>The resulting tree.</returns>
let replace before after tree =
    tree
...
/// <summary>
/// Returns the concatenation of trees produced by applying the mapping function to each element and its index.
/// </summary>
/// <param name="mapping">The mapping function to apply.</param>
/// <param name="tree">The input tree.</param>
/// <returns>The concatenation of the trees produced by applying the mapping function to each element and its index.</returns>
...
/// <summary>
/// Removes all instances of the specified value from the tree.
/// </summary>
/// <param name="value">The value to remove.</param>
/// <param name="tree">The input tree.</param>
/// <returns>The input tree minus all instances of the given item.</returns>
let without (value: 't) (tree: 't FingerTree) =
    tree
    |> filter ((<>) value)
/// <summary>
/// Removes all instances of the given values from the tree.
/// </summary>
/// <param name="values">The values to remove.</param>
/// <param name="tree">The input tree.</param>
/// <returns>The input tree minus all instances of the given items.</returns>
/// <exception cref="System.NullArgumentException"><c>values</c> was null.</exception>
let withoutMany (values: #seq<'t>) (tree: 't FingerTree) =
...
let pairs tree =
    fingerTree {
        ...
        for first in tree do
            let mutable innerIndex = 0
            
            for second in tree do
